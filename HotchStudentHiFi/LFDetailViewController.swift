...
class LFDetailViewController: UITableViewController {

    @IBOutlet weak var lblItemName: UILabel!
    @IBOutlet weak var lblItemDate: UILabel!
    @IBOutlet weak var lblItemContact: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if let item = self.item {
            lblItemName.text = item.LFitemName
            lblItemDate.text = item.formattedDate
            lblItemContact.text = item.LFcontact
